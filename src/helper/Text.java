...
/**
 * Helper class helping to draw strings on screen
 */
public class Text {
	/**
	 * Draws a string to the game screen
	 *
	 * @param s
	 * 		The string to be drawn
	 * @param x
	 * 		The x position the string should be drawn at
	 * @param y
	 * 		The y position the string should be drawn at
	 */
